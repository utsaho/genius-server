...
function verifyJWT(req, res, next) {
    ...
    if (!authHeader) {
        return res.status(401).send({ message: 'unauthorized Accedd' });
    }
...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASSWORD}@cluster0.03n63.mongodb.net/myFirstDatabase?retryWrites=true&w=majority`;
